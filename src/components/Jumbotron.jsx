  ...
  return (
    ...
    >
      <div className="mx-auto text-center py-24 ">
        ...
        <p className="[text-shadow:_0_1px_0_rgb(0_0_0_/_40%)] mb-2 font-semibold text-lg text-gray-200 lg:text-2xl sm:px-16 lg:px-48">
          Pengabdian Mahasiswa Untuk Edukasi, Sosialisasi dan Aksi Nyata.
        </p>
        <p className="[text-shadow:_0_1px_0_rgb(0_0_0_/_40%)] text-md font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">
          27-28 April 2024
        </p>
      </div>
    </div>
